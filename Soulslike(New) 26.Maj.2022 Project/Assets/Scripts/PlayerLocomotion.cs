    ...
    public class PlayerLocomotion : MonoBehaviour
    {
        ...
        public void HandleMovement(float delta)
        {
            ...
            if(inputHandler.lockOnFlag && inputHandler.sprintFlag == false)
            {
                ...
                (inputHandler.vertical, inputHandler.horizontal, playerManager.isSprinting);
        ...
        public void HandleFalling(float delta,Vector3 moveDirection)
        {
            ...
            Debug.DrawRay(orgin , -Vector3.up * minimumDistanceNeedToBeginFall,Color.red,0.1f,false);
            if(Physics.Raycast(orgin,-Vector3.up,out hit , minimumDistanceNeedToBeginFall, ignoreForGroundCheck))
            {
